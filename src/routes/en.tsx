...
export const Route = createFileRoute("/en")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: `CITYSTAR is a private residence of ${programme.nombreVillas} contemporary villas in Marrakech, close to the Palmeraie.`,
      },
      { property: "og:title", content: "CITYSTAR Marrakech — Private luxury villas" },
      {
        property: "og:description",
        content: `An exclusive collection of ${programme.nombreVillas} contemporary villas near Marrakech.`,
      },
