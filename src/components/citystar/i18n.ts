...
const fr = {
  ...
  frais: {
    ...
    imprimer: "Imprimer",
    neutre:
      "Les taux en vigueur n’ont pas encore été confirmés par le promoteur : aucun montant n’est affiché tant qu’ils ne le sont pas.",
...
const en: Textes = {
  ...
  frais: {
    ...
    lignes: {
      droitsEnregistrement: "Registration duties",
      conservationFonciere: "Land registry fees",
      fraisNotaire: "Notary fees",
    },
    ...
    imprimer: "Print",
    neutre:
      "The applicable rates have not been confirmed by the developer yet: no amount is shown until they are.",
